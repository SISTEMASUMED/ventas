...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-06-2022 a las 23:26:25
...
(1, 'Alberto Carlos Tapia', '2213247619', 'btotapia@hotmail.com', 'José Asunción silva', 1, '2022-05-27 01:05:34');
...
INSERT INTO `detalle_factura` (`id_detalle`, `numero_factura`, `id_producto`, `cantidad`, `noches`, `precio_venta`) VALUES
(128, 33, 1, 1, 1, 599),
(130, 35, 1, 1, 1, 599),
(127, 33, 1, 1, 1, 599),
(129, 34, 1, 1, 1, 599);
...
(93, 35, '2022-06-06 23:11:45', 1, 1, '1', '694.84', 1),
(92, 34, '2022-06-06 23:09:17', 1, 1, '1', '694.84', 1),
(91, 33, '2022-06-06 23:01:43', 1, 1, '1', '1389.68', 1);
...
(1, '47 ROOMS', 'Av. Gabriel Ruíz 3,  Col. El Dorado', 'Mazatlán', '82110', 'Sinaloa', '669-916-5319', 'ventas@47rooms.mx', 16, '$', 'img/1653626297_logo.png');
...
(1, '101', 'Habitacion sencilla, 2 personas cama King Size', 1, '2022-05-27 01:10:40', 599);
...
INSERT INTO `tmp` (`id_tmp`, `id_producto`, `cantidad_tmp`, `noches_tmp`, `precio_tmp`, `session_id`) VALUES
(31, 1, 1, 1, 599.00, '0svaivkearup4ro15ri2td7n4s');
...
(1, 'Alberto', 'Tapia', 'admin', '$2y$10$MPVHzZ2ZPOWmtUUGCq3RXu31OTB.jo7M9LZ7PmPQYmgETSNn19ejO', 'admin@admin.com', '2016-05-21 15:06:00');
...
--
ALTER TABLE `facturas`
  MODIFY `id_factura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
--
ALTER TABLE `tmp`
  MODIFY `id_tmp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;
