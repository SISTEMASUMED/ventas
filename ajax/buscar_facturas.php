			  ...
			  <table class="table  table-striped" id="myTable">
				...
				////////////////////////////
					...
					<tr>
						...
						echo		
						"<a href='./clonar_factura.php?id_factura=".$id_factura."&numero_factura=".$numero_factura."' class='btn btn-default' title='Clonar factura' ><i class='glyphicon glyphicon-retweet'></i></a>";  
...
if ($rj_usuario['is_admin']==1){
	...
	<a href='editar_factura.php?id_factura=".$id_factura."' class='btn btn-default' id='editar_btn'  title='Editar factura' onclick='notificaciones()' ><i class='glyphicon glyphicon-edit'></i></a>
