			  ...
			  <table class="table table-striped">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr >
						...
						?>
						<td >
						<select class="col-md-auto column-font-small" id="almacen_<?php echo $id_producto; ?>"style="width:100%;">
						...
						<td class=''>
						<div class="">
						<input type="text" class="form-control column-font-small" style="width:100%;" id="lote_<?php echo $id_producto; ?>" >
						</div></td>
						<td class='size-xl col-sm-1'>
						<div class="pull-right">
						<input type="date" class="form-control column-font-small" style="width:80%;" id="caducidad_<?php echo $id_producto; ?>" >
						</div></td>
						<td class='col-xs-1'>
						<div class="pull-right">
						...
						<input type="text" class="form-control" style="text-align:right width:80%;" id="precio_venta_<?php echo $id_producto ;?>"  >
