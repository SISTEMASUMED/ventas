			  ...
			  <table class="table  table-striped" id="myTable2">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td class=" "><?php echo $expediente; ?></td>
					...
					?>
						<td class=" "><?php echo $factura_status; ?></td>
...
//echo "<script> console.log('".$rj_usuario['is_admin']."')</script>";
...
if ($rj_usuario['is_admin']==1 || $rj_usuario['is_admin']==2){
	...
	//$consulta_admin=mysqli_query($con,"select * from materiales_servicio where numero_servicio = '$numero_servicio' and id_vendedor='$id_ventas'" );
	//$count_admin=mysqli_num_rows($consulta_admin);
	...
	//}else{
		...
		//echo "
		//<a href='agregar_materiales.php?id_servicio=".$id_servicio."&numero_servicio=".$numero_servicio."&id_vendedor=".$id_ventas."' class='btn btn-default' title='Agregar materiales' ><i class='glyphicon glyphicon-list-alt'></i></a> 		
		//";
	//}
  ...
  ";}
	...
	elseif ($rj_usuario['is_admin']==3 || $rj_usuario['is_admin']==4) {
