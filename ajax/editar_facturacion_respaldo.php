...
$insert_tmp=mysqli_query($con, "INSERT INTO detalle_factura (id_detalle,numero_factura,id_producto,sku,referencia,lote,almacen,cantidad,precio_venta,id_vendedor) VALUES (NULL,'$numero_factura','$id','$sku','$referencia','$lote','$almacen','$cantidad', '$precio_venta','$id_vendedor')");
