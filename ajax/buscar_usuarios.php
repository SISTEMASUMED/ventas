<?php
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $aColumns = array('nombre', 'user_email','user_name');//Columnas de busqueda
		 $sTable = "users";
		 $sWhere = "";
		if ( $_GET['q'] != "" )
		{
			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class="info">
					...
					<th class="hidden-xs">Letra de remisiones</th>
					<th class="hidden-xs"><span class="pull-right">Acciones</span></th>
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<input type="hidden" value="<?php echo $letra;?>" id="letra<?php echo $letra;?>">
					<tr>
						<td  class="columnas hidden-xs"><?php echo $user_id; ?></td>
						<td  class="columnas "><?php echo $fullname; ?></td>
						<td  class="columnas hidden-xs"><?php echo $user_name; ?></td>
						<td  class="columnas hidden-xs"><?php echo $user_email; ?></td>
						<td class="columnas hidden-xs">"<?php echo $letra?>"</td>
