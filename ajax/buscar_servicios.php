...
error_reporting(0);
	...
	if($action == 'ajax'){
		...
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $sWhere = "";
		 $sWhere.=" WHERE servicios.id_hospital=clientes.id_cliente and servicios.id_vendedor=users.user_id and servicios.fecha_servicio >= DATE_SUB(CURDATE(), INTERVAL 4 MONTH) ";
		if ( $_GET['q'] != "" )
		{
	
		}
		$sWhere.=" order by servicios.fecha_servicio desc";
		...
		users.user_id, users.nombre, users.letra FROM $sTable  $sWhere  ";
