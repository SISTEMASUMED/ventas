...
if (isset($_POST['noches'])){$noches=intval($_POST['noches']);}
...
{
$insert_tmp=mysqli_query($con, "INSERT INTO detalle_factura (numero_factura, id_producto,cantidad,noches,precio_venta) VALUES ('$numero_factura','$id','$cantidad','$noches','$precio_venta')");
...
<?php
	...
	$precio_total=$precio_venta_r*$cantidad*$noches;
