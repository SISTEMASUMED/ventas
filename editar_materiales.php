<?php
	...
	$id_servicio1=($_GET['id_servicio']);
	$numero_servicio1 = ($_GET['numero_servicio']); 
	$id_vendedor1= ($_GET['id_vendedor']); 

	$_SESSION['id_servicio']=$id_servicio1;
	$_SESSION['numero_servicio']=$numero_servicio1;
	$_SESSION['id_vendedor']=$id_vendedor1;
...
<html lang="es">
  ...
  <body>
    ...
    <script type="text/javascript" src="js/editar_materiales.js"></script>
