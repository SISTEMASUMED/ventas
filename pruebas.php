...
error_reporting(0);
	...
	if($action == 'ajax'){
		...
		$aColumns = array('paterno','nombre_cliente','nombre');//Columnas de busqueda
	    ...
	    $sql="SELECT * FROM $sTable $sWhere LIMIT $offset,$per_page  ";
		 echo "<script>console.log('$sWhere');</script>";
...
if ($rj_usuario['is_admin']==1){
	$consulta=mysqli_query($con,"select * from materiales_servicio where numero_servicio = '$numero_servicio'");
	...
	<a href='#' class='btn btn-default' title='Ver factura' onclick='ver_factura(".$id_servicio.",".$numero_servicio.",".$id_materiales.");'><i class='glyphicon glyphicon-eye-open'></i></a> 
	<a href='#' class='btn btn-default' title='Descargar factura' onclick='imprimir_factura(".$id_servicio.",".$numero_servicio.");'><i class='glyphicon glyphicon-download'></i></a> 
	<a href='#' class='btn btn-default' title='Borrar factura' onclick='eliminar(".$numero_servicio.");'><i class='glyphicon glyphicon-trash'></i> </a>
  ";}
		...
		";
		 ...
		 echo "
	<a href='#' class='btn btn-default' title='Ver factura' onclick='ver_factura(".$id_servicio.",".$numero_servicio.");'><i class='glyphicon glyphicon-eye-open'></i></a>
	<a href='#' class='btn btn-default' title='Descargar factura' onclick='imprimir_factura(".$id_servicio.",".$numero_servicio.");'><i class='glyphicon glyphicon-download'></i></a>
	</td>";
