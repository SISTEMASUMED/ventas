...
$("#datos_factura").submit(function(){
 ...
 VentanaCentrada('./pdf/documentos/factura_pdf.php?id_cliente='+id_cliente+'&id_vendedor='+id_vendedor+'&letra_ventas='+letra_ventas+'&compra='+compra+'&cotizacion='+cotizacion+'&doctor='+doctor+'&paciente='+paciente);
 });
