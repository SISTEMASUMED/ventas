		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax"></div>
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Nombre completo" required>
				</div>
			  </div>
			  ...
			  <div class="form-group">
				<label for="user_letra" class="col-sm-3 control-label">Letra para remisiones</label>
				<div class="col-sm-8">
				  <input type="letra" class="form-control" id="letra" name="letra" placeholder="Letra para usar en remisiones" required>
				</div>
			  </div>
			  <div class="form-group">
