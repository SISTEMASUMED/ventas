<?php
	...
	$sql_count=mysqli_query($con,"select * from facturas where id_vendedor = '".$session_id2."' and id_factura='".$id_factura."'");
	...
	$sql_factura=mysqli_query($con,"select * from facturas where id_vendedor = '".$session_id2."' and id_factura='".$id_factura."'");
