...
<div class="container">  
    ...
    <table id="" cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt; margin-top: 0%;">
    <tr>
    ...
    <tr>
        <td style="width:25%; font-size:10px;" class='midnight-blue'>Sala</td>
		   <td style="width:20%; font-size:10px;" class='midnight-blue'>Hora de inicio</td>
		   <td style="width:20%; font-size:10px;" class='midnight-blue'>Hora de termino</td>
           <td style="width:20%; font-size:10px;" class='midnight-blue'>Turno</td>
           <td style="width:20%; font-size:10px;" class='midnight-blue'>Diagnostico</td>
        </tr>
        <tr>
