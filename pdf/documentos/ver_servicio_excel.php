<?php
    ...
    $letra_servicio=$rw_user['user_id'];
    ...
    header("Content-Type: application/xls; charset=iso-8859-1");
	 header("Content-Disposition: attachment; filename=remision_S_I_DIG/".$letra_servicio."-".$numero_servicio.".xls");
	include(dirname('__FILE__').'/res/ver_servicio_excel_html.php');
