...
while ($row = mysqli_fetch_array($sql)) {
	...
	$nums++;
	echo "<script>console.log('work:".$id_vendedor."');</script>";
//}
...
$valor_x=1;
$insert = mysqli_query($con, "INSERT INTO facturas VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$total_factura','1','$compra','$cotizacion','$doctor','$paciente','$material','$pago','$d_factura','$observaciones')");	
