  ...
  <?php
    ...
    <div class="container-fluid">
		...
		?>		
			...
			echo	
				"<a  href='nueva_factura_2.php' class='btn btn-info'><span class='glyphicon glyphicon-plus' ></span> Nueva Remisión de Servicios</a>";
			}?>
	</div>
				
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Remisión de Servicio Integral</h4>
		</div>
			<div class="panel-body">
			<?php
			include("modal/bloqueo_remision.php");
			?>
	...
	<script type="text/javascript" src="js/servicios_integrales.js"></script>
  </body>
</html>
<script>
...
$( "#editar_estado" ).submit(function( event ) {
		   ...
		   var parametros = $(this).serialize();
			   $.ajax({
					  type: "POST",
					  url: "ajax/bloqueo_remisiones.php",
					  data: parametros,
					   beforeSend: function(objeto){
